package InheritanceDemo;   //package
...
// subclass of circle 
class Circle extends GeometricObject{       // inheriting the contents of the superclass in the class circle using extends keyword 
